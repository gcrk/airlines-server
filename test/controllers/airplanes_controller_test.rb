...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { columns: @airplane.columns, rows: @airplane.rows, type: @airplane.type } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { columns: @airplane.columns, rows: @airplane.rows, type: @airplane.type } }
